...
<head>
    ...
    h2 {
        color: #333;
        border-bottom: 2px solid #01d1ca; /* Change border color here */
        padding-bottom: 10px;
        margin-bottom: 30px;
    }
    ...
    input[type="password"] {
        ...
        padding: 12px;
        margin-bottom: 20px;
        border: 1px solid #01d1ca; /* Change border color here */
        border-radius: 4px;
    ...
    .btn-block {
        display: block;
        width: 100%;
        background: #01d1ca; /* Change button background color here */
    }
